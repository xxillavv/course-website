...
import { OurCourse } from "./OurCourse.js"
import { ourDirectData, ourTeamData, reviewIcons } from "../../data.js"
import { Member } from "../../components/Team/Member.js"
        ...
        <div className="container">
          ...
          <div className="reviews__box">
            {reviewIcons.map((el, index) => {
              return <img className="reviews__box-img" src={el} key={index} />
            })}
          </div>
        </div>
      </section>
