import type { IOurDirectData } from '../../types/interfaces.js';

type TOurCourseData = {ourCourseData: IOurDirectData}

export const OurCourse = ({ ourCourseData }: TOurCourseData) => {
  return (
