...
import type { ICoursePageMembersData } from "../../types/interfaces.js"

type TCourseData = {courseData: ICoursePageMembersData}

export const CoursesItemMembers = ({ courseData }: TCourseData) => {
  return (
