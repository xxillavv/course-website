          ...
          <div className="footer__map">
            ...
            <ul className="footer__map-list">
              <li className="footer__map-list-item">
                <Link to="../aboutus" className="footer__map-list-item-link">About Us</Link>
              </li>
              <li className="footer__map-list-item">
                <Link to="../courses" className="footer__map-list-item-link">Courses</Link>
              </li>
              <li className="footer__map-list-item">
                <Link to="../events" className="footer__map-list-item-link">Events</Link>
              </li>
              <li className="footer__map-list-item">
                <Link to="../blog" className="footer__map-list-item-link">Blog</Link>
              </li>
              <li className="footer__map-list-item">
                <Link to="../contacts" className="footer__map-list-item-link">Contacts</Link>
              </li>
            </ul>
          </div>
